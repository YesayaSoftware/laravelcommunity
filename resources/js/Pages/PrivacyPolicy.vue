<template>
    ...
    <div class="font-sans text-gray-900 dark:text-gray-500 antialiased">
        <div class="pt-4 bg-gray-100 dark:bg-gray-900">
            <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
                ...
                <div
                    class="w-full sm:max-w-2xl mt-6 p-6 bg-white dark:bg-gray-800 dark:text-gray-500 shadow-md overflow-hidden sm:rounded-lg prose max-w-prose mx-auto">
                    <h1 class="dark:text-gray-400">Privacy Policy</h1>

                    <p class="text-sm">Last updated: October 16, 2021</p>
                    ...
                    <h1 class="dark:text-gray-400">Interpretation and Definitions</h1>

                    <h2 class="dark:text-gray-400">Interpretation</h2>
                    ...
                    <h2 class="dark:text-gray-400">Definitions</h2>
                    ...
                    <ul class="bg-transparent">
                        <li>
                            <p>
                                <strong class="dark:text-gray-300">Account</strong> means a unique account created for
                                You to access our Service or
                        ...
                        <li>
                            <p>
                                <strong class="dark:text-gray-300">Affiliate</strong> means an entity that controls, is
                        ...
                        <li>
                            <p>
                                <strong class="dark:text-gray-300">Application</strong> means the software program
                                provided by the Company
                                downloaded by You on any electronic device, named Laravel Community App
                            </p>
                        </li>

                        <li>
                            <p>
                                <strong class="dark:text-gray-300">Company</strong> (referred to as either &quot;the
                                Company&quot;, &quot;We&quot;,
                                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Laravel Community.
                            </p>
                        </li>

                        <li>
                            <p>
                                <strong class="dark:text-gray-300">Cookies</strong> are small files that are placed on
                        ...
                        <li>
                            <p><strong class="dark:text-gray-300">Country</strong> refers to: Tanzania</p>
                        </li>

                        <li>
                            <p><strong class="dark:text-gray-300">Device</strong> means any device that can access the
                        ...
                        <li>
                            <p>
                                <strong class="dark:text-gray-300">Personal Data</strong> is any information that
                        ...
                        <li>
                            <p><strong class="dark:text-gray-300">Service</strong> refers to the Application or the
                                Website or both.</p>
                        </li>

                        <li>
                            <p>
                                <strong class="dark:text-gray-300">Service Provider</strong> means any natural or legal
                                person who processes the
                        ...
                        <li>
                            <p><strong class="dark:text-gray-300">Third-party Social Media Service</strong> refers to
                                any website or any social
                        ...
                        <li>
                            <p>
                                <strong class="dark:text-gray-300">Usage Data</strong> refers to data collected
                        ...
                        <li>
                            <p>
                                <strong class="dark:text-gray-300">Website</strong> refers to Laravel Community,
                                accessible from <a
                                href="https://laravelcommunity.co.tz/" class="dark:text-gray-300"
                                rel="external nofollow noopener" target="_blank">https://laravelcommunity.co.tz/</a>
                            </p>
                        </li>

                        <li>
                            <p>
                                <strong class="dark:text-gray-300">You</strong> means the individual accessing or using
                                the Service, or the
                                company,
                    ...
                    <h1 class="dark:text-gray-500">Collecting and Using Your Personal Data</h1>

                    <h2 class="dark:text-gray-500">Types of Data Collected</h2>

                    <h3 class="dark:text-gray-500">Personal Data</h3>
                    ...
                    <h3 class="dark:text-gray-300">Usage Data</h3>
                    ...
                    <h3 class="dark:text-gray-500">Information from Third-Party Social Media Services</h3>
                    ...
                    <h3 class="dark:text-gray-500">Tracking Technologies and Cookies</h3>
                    ...
                    <ul>
                        <li>
                            <strong class="dark:text-gray-300">Cookies or Browser Cookies.</strong> A cookie is a small
                        ...
                        <li>
                            <strong class="dark:text-gray-300">Flash Cookies.</strong> Certain features of our Service
                            may use local stored objects
                            (or Flash Cookies) to collect and store information about Your preferences or Your activity
                            on our Service.
                        </li>

                        <li>
                            <strong class="dark:text-gray-300">Web Beacons.</strong> Certain sections of our Service and
                    ...
                    <p>
                        ...
                        href="https://www.freeprivacypolicy.com/blog/cookies/" class="dark:text-gray-300"
                        target="_blank">Cookies: What Do They
                        Do?</a>.
                    </p>
                    ...
                    <ul>
                        <li>
                            <p><strong class="dark:text-gray-300">Necessary / Essential Cookies</strong></p>
                        ...
                        <li>
                            <p><strong class="dark:text-gray-300">Cookies Policy / Notice Acceptance Cookies</strong>
                            </p>
                        ...
                        <li>
                            <p><strong class="dark:text-gray-300">Functionality Cookies</strong></p>
                    ...
                    <h2 class="dark:text-gray-500">Use of Your Personal Data</h2>

                    <p>The Company may use Personal Data for the following purposes:</p>

                    <ul>
                        <li>
                            <p><strong class="dark:text-gray-300">To provide and maintain our Service</strong>,
                        ...
                        <li>
                            <p>
                                <strong class="dark:text-gray-300">To manage Your Account:</strong> to manage Your
                                registration as a user of the
                        ...
                        <li>
                            <p>
                                <strong class="dark:text-gray-300">For the performance of a contract:</strong> the
                        ...
                        <li>
                            <p>
                                <strong class="dark:text-gray-300">To contact You:</strong> To contact You by email,
                                telephone calls, SMS, or other
                        ...
                        <li>
                            <p>
                                <strong class="dark:text-gray-300">To provide You</strong> with news, special offers and
                        ...
                        <li>
                            <p><strong class="dark:text-gray-300">To manage Your requests:</strong> To attend and manage
                                Your requests to Us.</p>
                        </li>

                        <li>
                            <p>
                                <strong class="dark:text-gray-300">For business transfers:</strong> We may use Your
                        ...
                        <li>
                            <p>
                                <strong class="dark:text-gray-300">For other purposes</strong>: We may use Your
                                information for other purposes, such
                    ...
                    <ul>
                        <li>
                            <strong class="dark:text-gray-300">With Service Providers:</strong> We may share Your
                            personal information with Service
                            Providers to monitor and analyze the use of our Service, to contact You.
                        </li>

                        <li>
                            <strong class="dark:text-gray-300">For business transfers:</strong> We may share or transfer
                        ...
                        <li>
                            <strong class="dark:text-gray-300">With Affiliates:</strong> We may share Your information
                        ...
                        <li>
                            <strong class="dark:text-gray-300">With business partners:</strong> We may share Your
                            information with Our business
                            partners to offer You certain products, services or promotions.
                        </li>

                        <li>
                            <strong class="dark:text-gray-300">With other users:</strong> when You share personal
                        ...
                        <li>
                            <strong class="dark:text-gray-300">With Your consent</strong>: We may disclose Your personal
                            information for any other
                            purpose with Your consent.
                        </li>
                    </ul>

                    <h2 class="dark:text-gray-500">Retention of Your Personal Data</h2>
                    ...
                    <h2 class="dark:text-gray-500">Disclosure of Your Personal Data</h2>

                    <h3 class="dark:text-gray-500">Business Transactions</h3>
                    ...
                    <h3 class="dark:text-gray-500">Law enforcement</h3>
                    ...
                    <h3 class="dark:text-gray-500">Other legal requirements</h3>
                    ...
                    <h2 class="dark:text-gray-500">Security of Your Personal Data</h2>
                    ...
                    <h1 class="dark:text-gray-500">Children's Privacy</h1>
                    ...
                    <h1 class="dark:text-gray-500">Links to Other Websites</h1>
                    ...
                    <h1 class="dark:text-gray-500">Changes to this Privacy Policy</h1>
                    ...
                    <h1 class="dark:text-gray-500">Contact Us</h1>

                    <p>If you have any questions about this Privacy Policy, You can contact us:</p>

                    <ul>
                        <li>
                            <p>By email: info@laravelcommunity.co.tz</p>
                        </li>

                        <li>
                            <p>
                                By visiting this page on our website: <a href="https://laravelcommunity.co.tz/"
                                                                         rel="external nofollow noopener"
                                                                         class="dark:text-gray-300"
                                                                         target="_blank">https://laravelcommunity.co.tz/</a>
                            </p>
                        </li>
                    </ul>
                </div>
