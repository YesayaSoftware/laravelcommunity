                ...
                <div class="space-y-12">
                    ...
                    <div class="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
                        <div  v-for="newsletter in newsletters" :key="newsletter.id"
                            ...
                            <inertia-link :href="route('newsletters.show', newsletter.slug)" class="block mt-2">
                                <div class="flex-shrink-0">
                                    <img class="h-48 w-full object-cover" :src="newsletter.thumbnail_url" :alt="newsletter.title"/>
                                </div>
                                    ...
                                    <div class="mt-6 flex items-center">
                                        <div class="ml-3">
                                            ...
                                            <div class="flex space-x-1 text-sm text-gray-500">
                                                <time :datetime="newsletter.created_at">
